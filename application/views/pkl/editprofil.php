      ...
      <div class="row pb-2">
          <div class="col-md-12">
            <div class="wrap bg-white rounded-lg pt-4 pl-3 pr-3 pb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= site_url('C_pkl/editprofil') ?>" method="post">
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Nama Sekolah</label>
                                <div class="col-sm-6">
                                    <input name="nama_sekolah" type="text" class="form-control" value="<?= $data->nama_sekolah ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="alamat_sekolah" rows="3" class="form-control"><?= $data->alamat_sekolah ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input name="mulai" type="date" class="form-control" value="<?= $data->mulai ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Selesai</label>
                                <div class="col-sm-6">
                                    <input name="selesai" type="date" class="form-control" value="<?= $data->selesai ?>">
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-md-2"><button class="btn btn-success" type="submit">Simpan</button></div>
                            </div>
                        </form>
                    </div>
                </div>
